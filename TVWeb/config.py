...
class Config(object):
    ...
    SQLALCHEMY_DATABASE_URI = "postgresql://"+os.getenv('POSTGRES_USER')+":"+os.getenv('POSTGRES_PASSWORD')+"@"+os.getenv('POSTGRES_HOST')+"/"+os.getenv('POSTGRES_DB') # TODO: avoid credentials + right adress
